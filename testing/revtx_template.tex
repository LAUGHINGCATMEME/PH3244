...
\centering
ABSTREACXCT
make sure that teh 1 ref is github, 2 is error pro and 3rd is the error proopogation book
\end{abstract}
\maketitle
\tableofcontents
\vspace*{\fill}
...
Furthermore after calculating the standard deviation, we propogate the error as follows []

for result we use two times the standard error [4] wiki of standard error
for 95 percent 1.96
\subsection{obs1}
